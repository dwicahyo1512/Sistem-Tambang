...
<body
                                ...
                                <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600"
                                    ...
                                    <a href="#!" class="flex gap-3 mb-3">
                                            ...
                                            <div class="rounded bg-slate-100 dark:bg-zink-500">
                                                ...
                                                @elseif (Auth::user()->gender === 'male')
                                                    <img src="{{ asset('assets/images/avatar-2.png') }}"
                                                        alt="Male Avatar" class="w-12 h-12 rounded">
                                                @else
                                                    <img src="{{ asset('assets/images/avatar-3.png') }}"
                                                        alt="Female Avatar" class="w-12 h-12 rounded">
                                                @endif
                                            </div>
                                            <span
                                        ...
                                        <div>
                                            ...
                                            <p class="text-slate-500 dark:text-zink-300">{{ Auth::user()->user_id }}
                                            </p>
                                        </div>
                                    </a>
                                    <ul>
                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            </script> Sistem Tambang Kh
                        </div>
                        <div class="hidden lg:block">
                            <div class="ltr:text-right rtl:text-left">
                                Design & Develop by Sistem Tambang Kh
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="customizerButton" drawer-end=""
        ...
        <div class="flex justify-between p-4 border-b border-slate-200 dark:border-zink-500">
            <div class="grow">
                <h5 class="mb-1 text-16">Sistem Tambang Theme Customizer</h5>
