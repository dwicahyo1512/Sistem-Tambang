                                ...
                                @foreach ($kendaraans as $index => $kendaraan)
                                    <tr>
                                        ...
                                        <td class="px-3.5 py-2.5 border-y border-custom-200 dark:border-custom-900">
                                            ...
                                            <form action="{{ route('check', $kendaraan->id) }}" method="POST" class="inline">
                                                @csrf
                                                @method('put')
                                                <button type="submit"
                                            ...
                                            @endcan
                                            @can('read pool')
                                            <form action="{{ route('setuju', $kendaraan->id) }}" method="POST" class="inline">
                                                @csrf
                                                @method('put')
    ...
    <div id="addkendaraanModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="{{ route('kendaraans.store') }}" class="mt-10" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="img_kendaraan" class="inline-block mb-2 text-base font-medium">Image Kendaraan</label>
