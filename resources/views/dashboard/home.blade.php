            ...
            <div class="grid grid-cols-12 gap-x-5">
                ...
                <div
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="mt-5 mb-2"><span class="counter-value" data-target="1">0</span>M <span
                                class="counter-value" data-target="29">0</span>sec</h5>
                ...
                <div
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-slate-500 dark:text-slate-200">Total Pegawai</p>
                    </div>
                </div><!--end col-->
